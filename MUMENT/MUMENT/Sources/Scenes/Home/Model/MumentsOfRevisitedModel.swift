...
extension MumentsOfRevisitedModel {
    static var sampleData: [MumentsOfRevisitedModel] = [
        ...
        MumentsOfRevisitedModel(albumImageName:"image6", title: "L", contents: "볼 때마다 노래가 이렇게 사랑스러울 수 있 수 울 수", profileImageName:"image2", writerName: "이수지"),
        ...
        MumentsOfRevisitedModel(albumImageName:"image4", title: "별을 남은 다 걱정도 슬퍼하는 겨울이 이름을 별 소녀들의 까닭입니다.", contents: "덮어 아스라히 불러 별에도 이름과, 거외다.", profileImageName:"image5", writerName: "이수지")
    ]
}
