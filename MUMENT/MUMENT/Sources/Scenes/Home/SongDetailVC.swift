...
class SongDetailVC: BaseVC {
    ...
    private func setTV() {
        ...
        mumentTV.register(cell: SongDetailTVC.self, forCellReuseIdentifier: SongDetailTVC.className)
...
extension SongDetailVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            guard let cell = tableView.dequeueReusableCell(withIdentifier: SongDetailTVC.className, for: indexPath) as? SongDetailTVC else {
