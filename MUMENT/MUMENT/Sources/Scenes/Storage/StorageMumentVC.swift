...
extension StorageMumentVC {
    private func mapMyMumentData(data:[GetMyMumentResponseModel.Mument]) {
        ...
        data.forEach {
            let storageMumentData = StorageMumentModel(id: $0.id, user: $0.user, music: $0.music, isFirst: $0.isFirst, impressionTag: $0.impressionTag, feelingTag: $0.feelingTag, cardTag: $0.cardTag, content: $0.content, isPrivate: $0.isPrivate, isLiked: $0.isLiked, createdAt: $0.createdAt, year: $0.year, month: $0.month, likeCount: $0.likeCount)
            self.storageMumentData.append(storageMumentData)
        }
    }
    ...
    private func mapLikedMumentData(data:[GetLikedMumentResponseModel.Mument]) {
        self.storageMumentData = []
        data.forEach {
            let storageMumentData = StorageMumentModel(id: $0.id, user: $0.user, music: $0.music, isFirst: $0.isFirst, impressionTag: $0.impressionTag, feelingTag: $0.feelingTag, cardTag: $0.cardTag, content: $0.content, isPrivate: $0.isPrivate, isLiked: $0.isLiked, createdAt: $0.createdAt, year: $0.year, month: $0.month, likeCount: nil)
            self.storageMumentData.append(storageMumentData)
        }
    }
