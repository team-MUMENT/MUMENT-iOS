...
extension MumentCardBySongModel {
    ...
    static var allMumentsSampleData: [MumentCardBySongModel] = [
        ...
        MumentCardBySongModel(profileImageTitle:"image1", writerName:"이수지1", contents:"이웃 멀듯이, 이름과, 거외다. 피어나듯이 위에 불러 아이들의 쓸쓸함과 무엇인지 별 그리워 버리었습니다.", createdAt:"1 Sep, 2020", isLiked:true, heartCount:15,isFirst:true, impressionTags: [100,101], feelingTags:[]),
        ...
        MumentCardBySongModel(profileImageTitle:"image5", writerName:"이수지", contents:" 패, 시인의 가을로 별 어머니 봅니다. 책상을 시인의 당신은 가을로 내일 가득 있습니다.", createdAt:"1 Sep, 2020", isLiked:false, heartCount:7,isFirst:true, impressionTags: [100,101], feelingTags:[205]),
        ...
        MumentCardBySongModel(profileImageTitle:"image2", writerName:"이수지", contents:"우는 어머니 멀듯이, 시와 자랑처럼 아이들의 별 무성할 계십니다. 남은 옥 했던 별이 패, 봄이 까닭입니다.", createdAt:"1 Sep, 2020", isLiked:true, heartCount:5,isFirst:true, impressionTags: [100,101], feelingTags:[])
    ]
}
